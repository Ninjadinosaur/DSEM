// Generated by tools/convert_melonds_shaders.py from melonDS's FinalPassFS.glsl (GPL-3.0-or-later,
// Copyright 2016-2026 melonDS team). Edit the converter, not this file.
#version 450

layout(set = 0, binding = 0) uniform sampler2D MainInputTexA;
layout(set = 0, binding = 1) uniform sampler2D MainInputTexB;
layout(set = 0, binding = 2) uniform sampler2DArray AuxInputTex;
