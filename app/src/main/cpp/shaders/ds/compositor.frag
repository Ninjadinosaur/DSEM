// Generated by tools/convert_melonds_shaders.py from melonDS's 2DCompositorFS.glsl (GPL-3.0-or-later,
...
layout(set = 0, binding = 0) uniform sampler2D BGLayerTex[4];
layout(set = 0, binding = 1) uniform sampler2DArray OBJLayerTex;
layout(set = 0, binding = 2) uniform sampler2DArray Capture128Tex;
layout(set = 0, binding = 3) uniform sampler2DArray Capture256Tex;
layout(set = 0, binding = 4) uniform isampler2D MosaicTex;
...
layout(std140, set = 0, binding = 5) uniform ubBGConfig
{
    int uVRAMMask;
...
layout(std140, set = 0, binding = 6) uniform ubScanlineConfig
{
    sScanline uScanline[192];
};

layout(std140, set = 0, binding = 7) uniform ubCompositorConfig
{
    ivec4 uBGPrio;
    bool uEnableOBJ;
    bool uEnable3D;
